...
Eye gazing in driving creates volatility in both normal and distracted driving. '0' Data is both blinking and eyes off-screen during texting distraction. This model is only focused on how eye gaze variance affects lane driving in the normal driving mode.
